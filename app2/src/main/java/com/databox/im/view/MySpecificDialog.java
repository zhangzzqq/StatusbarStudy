...
public class MySpecificDialog extends Dialog {
     ...
     * 主按钮位置
     */
    private int mainBtnDirection = RIGHT;

    private static final int LEFT = 0;
    private static final int RIGHT = 1;
    private boolean setCanceledOnTouchOutside = true;
    private boolean setCanceled = true;
    ...
    private MySpecificDialog(Context context) {
        this(context, R.style.RoundedDialogTheme);
    }
...
//    }
     ...
     * @param strRight
     */
    private MySpecificDialog initDialog(String strTitle, String strMessage, View view, String strLeft, String strRight, boolean setCanceledOnTouchOutside, boolean setCanceled) {
...
//        InitPixels();
        ...
        myDialog.setCanceledOnTouchOutside(setCanceledOnTouchOutside);
        myDialog.setCancelable(setCanceled);
//        this.setCanceledOnTouchOutside = setCanceledOnTouchOutside;
//        this.setCanceled = setCanceled;
    ...
    public static class Builder {
        ...
        public MySpecificDialog.Builder setCanceledOnTouchOutside(boolean setCanceledOnTouchOutside) {
            this.setCanceledOnTouchOutside = setCanceledOnTouchOutside;
            return this;
        }

        public MySpecificDialog.Builder setCancelable(boolean setCancelable) {
        ...
        public MySpecificDialog buildDialog() {
            ...
            if (width == 0) {
                width = (int) (getPxWidth(context) * 0.8);
            }
            mySpecificDialog.width = width;

            return mySpecificDialog.initDialog(strTitle, strMessage, view, strLeft, strRight, setCanceledOnTouchOutside, setCancelable);
...
//                    tvRight.setVisibility(View.GONE);
        ...
        //根据文字修改按钮样式
        if (strLeft.equals("cancel") || strLeft.equals("取消")) {
            tvLeft.setBackgroundResource(R.drawable.bg_alert_cancel);
            tvLeft.setTextColor(context.getResources().getColor(R.color.btn_text_cancel));
        } else {
            tvLeft.setBackgroundResource(R.drawable.bg_alert_confirm);
            tvLeft.setTextColor(context.getResources().getColor(R.color.btn_text_confirm));
        }
        if (strRight.equals("cancel") || strRight.equals("取消")) {
            tvRight.setBackgroundResource(R.drawable.bg_alert_cancel);
            tvRight.setTextColor(context.getResources().getColor(R.color.btn_text_cancel));
        } else {

            tvRight.setBackgroundResource(R.drawable.bg_alert_confirm);
            tvRight.setTextColor(context.getResources().getColor(R.color.btn_text_confirm));
        }
